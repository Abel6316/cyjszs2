...
public class MyTools {
	...
	public static boolean download(String URL ,Context context){
		
		//下载文件工具方法
		
		if(URLUtil.isHttpsUrl(URL)){
			Log.i("download","url is not httpurl");
			return false;
		}
		
		DownloadTask downloadTask = new DownloadTask(URL,SDCARD, URL.substring(URL
